...
export const translations = {
    en: {
        ...
        max_managed_notice: "🔒 This asset is managed by MAX Integration. Manual edits are disabled to ensure data consistency.",
        api_key: "API Key",
        ...
        reset_confirm_1: "Are you sure you want to delete ALL data? This action cannot be undone.",
        reset_confirm_2: "Double check: ALL assets, transactions, and goals will be lost. Confirm reset?",
        reset_success: "System has been reset to factory defaults.",
        reset_failed_server: "Reset failed. Please check server logs.",
        reset_failed_network: "Reset failed. Server might be down.",
        ...
        years: "Years",
        return_conservative: "Conservative (3%)",
        return_aggressive: "Aggressive (10%)",
    ...
    "zh-TW": {
        ...
        max_managed_notice: "🔒 此資產由 MAX 整合自動管理，已停用手動編輯以確保數據一致性。",
        api_key: "API Key",
        api_secret: "API Secret",
        ...
        reset_button: "重置所有資料",
        reset_confirm_1: "確定要刪除所有資料？此操作無法復原。",
        reset_confirm_2: "再次確認：所有資產、交易紀錄和目標都將遺失。確定重置？",
        reset_success: "系統已恢復出廠設定。",
        reset_failed_server: "重置失敗。請檢查伺服器日誌。",
        reset_failed_network: "重置失敗。伺服器可能已離線。",
        export_csv: "匯出 CSV",
        ...
        years_to_grow: "複利年限",
        years: "年",
        return_conservative: "保守型 (3%)",
        return_aggressive: "積極型 (10%)",
